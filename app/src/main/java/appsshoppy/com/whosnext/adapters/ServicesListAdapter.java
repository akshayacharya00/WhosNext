...
public class ServicesListAdapter extends BaseAdapter {
    ...
    List<Services> servicesArrayList = Collections.EMPTY_LIST;
    private static LayoutInflater inflater = null;
    public Resources res;

    public ServicesListAdapter(ArrayList<Services> servicesArrayList, Activity context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vi = inflater.inflate(R.layout.services_list_row_layout, null);
    ...
    public static class ViewHolder {
        TextView txtServiceName, txtServicePrice, txtServiceTime;
        Button bookService;
    }
